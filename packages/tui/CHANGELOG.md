...
- Added an experimental `app-viewport` render backend with application-owned transcript scrolling, pinned bottom chrome, fixed-grid alternate-screen painting, and text-safe image fallback.
